...
<html>
    ...
    <body>
        <div class="container">
                ...
                $soccerseason = $api->getSoccerseasonById(399);
                echo "<p><hr><p>"; ?>
 	...
 	$soccerseason2 = new Soccerseason($soccerseason->payload);
    $data = $soccerseason2->getLeagueTable();
    ?>
     <table class="table table-striped"> 
    
    <tr> <?php foreach ($data->standing as $standing){ ?>
	
	<td><?php	echo $standing->teamName;?></td>
	<td>	<?php echo "<img src=" . $standing->crestURI . ">";?></td>
